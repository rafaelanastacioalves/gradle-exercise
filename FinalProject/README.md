...
of four modules made by me:
* A Java library that provides jokes phrases, 
...
We already have an app that contains an activity with a banner ad and a button that purports to tell a
